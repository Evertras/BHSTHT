...
namespace HSDataTest
{
    ...
    public class CardTest
    {
        ...
        {
            Card sampleCard = new Card("X", 1, 1, Card.NoEffects);
        }
        ...
        {
            Card badCard = new Card("X", 1, -1, Card.NoEffects);
        }
        ...
        {
            Card badCard = new Card("X", 1, 1, null);
        }
        ...
        {
            Card someCard = new Card("X", 1, 1, new List<ICardEffect> { new CardEffectDamage(4) });
        ...
        {
            Card someCard = new Card("X", 1, 1, new List<ICardEffect> { new CardEffectDamage(4), new CardEffectDamage(2) });
